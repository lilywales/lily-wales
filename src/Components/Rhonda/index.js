...
import './rhonda.css';
import rhonda1 from './r1-min.jpg';
import rhonda2 from './r2-min.jpg';
import rhonda3 from './r3-min.jpg';
import rhonda4 from './r4.jpg';
import rhonda5 from './r5-min.jpg';
import rhonda6 from './r6-min.jpg';

class Rhonda extends Component {
	render() {
		return (
			<div >
				<img className="rhonda1" src={rhonda1} alt="A close up of Rhonda, showing half her circular form. Her surfce is multi-coloured with collages that of natural, mechanical and medical elements. The most prominent colours are red and blue tones. The background wall is white and at the bottom you can see the beige sand with dark speckles that she sits on." />
				<div className="rhonda2and3">
					<img className="rhonda2" src={rhonda2} alt="A close up of Rhonda showing the complex detail of her skin. It reference biological and unnatural forms to comment on nuclear culture." />
				...
				<img className="rhonda6" src={rhonda6} alt="Rhonda's full spherical form in the centre of the composition. Her surface multi-coloured and she sits on sand with the wall providing a white background." />
				...
				<div className="mobImgs">
					<img className="rhonda2mob" src={rhonda2} alt="A close up of Rhonda showing the complex detail of her skin. It reference biological and unnatural forms to comment on nuclear culture." />
