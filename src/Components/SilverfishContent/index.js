      ...
      <Linkify>
        ...
        <div className="image_wrapper">
          ...
          <div className="sfishText">
            <p>Still frames from the SILVERFISH trailer</p>
          </div>
          <img
            className="sfish2"
            src={sf2}
            alt="a bright pink fleshy background with black tones. A close up of the SILVERFISH split into 3 closely arranged boxes, the middle box is square and the other two are vertical rectangles. Within them the hard, scaley-shell like surface can be seen. it is mostly black with with green tones. an antenne can be seen and an organic turret pretudes from the middle."
          />
          <img
            className="sfish3"
            src={sf3}
            alt="a bright pink fleshy background with light pink tones. A large toxic green egg that has lime coloured slime at the top sits in the left side of the frame. There are 7 mini version of the same egg, varying in sizes, dotted around the frame"
          />
        </div>
      </Linkify>
    );
