  ...
  render() {
    return (
      ...
      <div className="mrOwlText">
        ...
        <img className="mrowl2" src={mrowl2} alt="The same piece as previous, only the enviroment is more visible. The work is shown within an old NHS rehab centre. A series of holes in the wall resemble bullet holes." />
        ...
        <img className="mrowl4" src={mrowl4} alt="A close up of the previous. A biolumenecent type creture with an entomological appearance. On its right hand side it is encased in a thin layer of white paint with splashes of pink. It appears to have a bulbous head and jelly fish like body that extends down in a curling futurist but natural tail. The upper half is surrounded by a neon yellow background" />
...
<img className="mrowl6" src={mrowl6} alt="The whole piece again but this time with more of the gallery space to be seen. The wall is white and there are brown floorboards. A red bench provides some scale for the viewer to see how large the piece is." />
        </div>
    );
  }
}
