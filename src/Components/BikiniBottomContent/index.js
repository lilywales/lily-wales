		...
		return (
			<div>
					...
					<div className="bb3and4 desktopImgs">
						<img className="bb3" src={bb3} alt="An orange background with a jellyfish like creature. It has a long black and white body with splahes of pink detail. There are six tentacles, some flow softly and others are shraper and more rigid." />
