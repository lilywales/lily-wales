...
class BlueStreakContent extends Component {
  render() {
    ...
    <MediaQuery maxWidth={600} minWidth={321}>
      ...
      <img className="bs2" src={bs2} alt="A close up of the same asslemblage in the first image. The blue clamp is visible holding the double exposed photomontage, which is the face of a human and mechanical creature. In the background there is a slime worm like parasite pierced through a trespasssing deterant fence spike. The blue watering can pouring out the entangled lock and tumour is also visible. The background is an electric blue colour. " />
      <img className="bs3" src={bs3} alt="The same assemblage as documented in the first image but from an angle head on. The objects and monatages take up the majority of the middle of the wall." />
      ...
      <img className="bs6" src={bs6} alt="This is a close up of the second concrete block from the previous image. on the surface of the block is a monatage of a blue streak missile composed of locks and orginal imagery of the missile itself. The montage is surrounded by a blue arcylic subastance." />
     </div>
    );
  }
}
